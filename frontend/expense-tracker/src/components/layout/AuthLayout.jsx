...
import CARA_2 from "../../assets/Images/card2.png";
    ...
    return (
        <div className="flex">
            ...
            <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
                ...
                <div className="grid grid-cols z-20">
                <StatsInfoCard
...
const StatsInfoCard = ({icon , label ,value , color}) =>{
    return(
        <div className="flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-400/10 border border-gray-200/15 z-10">
